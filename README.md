...
Works with [the official Ruby MongoDB driver](https://docs.mongodb.com/ruby-driver/master/quick-start/), or [the fantastic Minimongo](https://github.com/fugroup/minimongo) (recommended).
